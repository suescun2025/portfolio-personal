...
Para clonar y correr este proyecto en tu entorno local:

```bash
# 1. Clonar el repositorio
git clone https://github.com/suescun2025/portfolio-personal.git
...
Abre en tu navegador la URL local indicada (habitualmente `http://localhost:5173/portfolio-personal/`).
...
```bash
# Para compilar el bundle de producción manualmente:
npm run build
```
